...
public class MateriaController {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Lista de matérias exibida com sucesso"),
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Matéria encontrada com sucesso"),
			@ApiResponse(code = 404, message = "Matéria não encontrada"),
			@ApiResponse(code = 500, message = "Erro interno no serviço"), })
	@GetMapping("/{id}")
	public ResponseEntity<Response<MateriaDto>> consultaMaterias(@PathVariable Long id) {
		...
		response.setStatusCode(HttpStatus.OK.value());
		response.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(MateriaController.class).consultaMaterias(id))
				.withSelfRel());
		...
		response.add(
				WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(MateriaController.class).atualizarMateria(materia))
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "Matéria criada com sucesso"),
