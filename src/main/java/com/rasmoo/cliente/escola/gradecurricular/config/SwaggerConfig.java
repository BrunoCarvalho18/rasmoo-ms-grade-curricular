...
public class SwaggerConfig extends WebMvcConfigurationSupport {
	...
	public Docket gradeCurricularApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				 ...
				 .tags(new Tag(CURSO,"Operações referentes a manipulação")).tags(new Tag(MATERIA,"Operações referentes a manipulação da entidade Materia."));
	...
	private ApiInfo metaData() {
		return new ApiInfoBuilder().title("GRADE CURRICULAR")
				.description("Api responsável pela manutenção da grande curricular RASMOO SCHOOL")
